...
cd "${TOP}"
makeDirectory ${TMPDIR}/04a-lcd8bitdisplay.x/bin
copyFileToTmpDir "${OUTPUT_PATH}" "${TMPDIR}/${PACKAGE_TOP_DIR}bin/${OUTPUT_BASENAME}" 0755


# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/package/04a-lcd8bitdisplay.x.tar
cd ${TMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/package/04a-lcd8bitdisplay.x.tar *
checkReturnCode
