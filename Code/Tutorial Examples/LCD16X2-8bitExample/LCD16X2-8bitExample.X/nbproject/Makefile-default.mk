...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/LCD16X2-8bitExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/LCD16X2-8bitExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/LCD16X2-8bitExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/LCD16X2-8bitExample.X.${IMAGE_TYPE}.hex 
